...
│
├── hooks/
│   ├── use-fit-check.js      # SSE client state machine
...
- Container width animation (max-w-2xl → max-w-5xl)
...
**Purpose**: Displays pipeline phase progress with visual status indicators.
